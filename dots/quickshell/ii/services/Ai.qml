...
Singleton {
    ...
    property Component copilotCliApiStrategy: CopilotCliApiStrategy {}
    ...
    property var models: Config.options.policies.ai === 2 ? {} : {
        ...
        "copilot-claude-opus-4.6": aiModelComponent.createObject(this, {
            "name": "Claude Opus 4.6",
            "icon": "copilot-symbolic",
            "description": Translation.tr("GitHub Copilot | Anthropic Claude Opus 4.6\nPowerful reasoning. Requires GitHub Copilot subscription"),
            "homepage": "https://github.com/features/copilot",
            "endpoint": "copilot-cli",
        ...
        "copilot-claude-opus-4.5": aiModelComponent.createObject(this, {
            "name": "Claude Opus 4.5",
            "icon": "copilot-symbolic",
            "description": Translation.tr("GitHub Copilot | Anthropic Claude Opus 4.5\nDeep reasoning. Requires GitHub Copilot subscription"),
            "homepage": "https://github.com/features/copilot",
            "endpoint": "copilot-cli",
        ...
        "copilot-claude-sonnet-4.5": aiModelComponent.createObject(this, {
            "name": "Claude Sonnet 4.5",
            "icon": "copilot-symbolic",
            "description": Translation.tr("GitHub Copilot | Anthropic Claude Sonnet 4.5\nBalanced speed and quality. Requires GitHub Copilot subscription"),
            "homepage": "https://github.com/features/copilot",
            "endpoint": "copilot-cli",
        ...
        "copilot-gpt-5.3-codex": aiModelComponent.createObject(this, {
            "name": "GPT-5.3 Codex",
            "icon": "copilot-symbolic",
            "description": Translation.tr("GitHub Copilot | OpenAI GPT-5.3 Codex\nCode-specialized. Requires GitHub Copilot subscription"),
            "homepage": "https://github.com/features/copilot",
            "endpoint": "copilot-cli",
            "model": "gpt-5.3-codex",
            "requires_key": false,
        ...
        "copilot-gpt-5.2-codex": aiModelComponent.createObject(this, {
            "name": "GPT-5.2 Codex",
            "icon": "copilot-symbolic",
            "description": Translation.tr("GitHub Copilot | OpenAI GPT-5.2 Codex\nCode-specialized. Requires GitHub Copilot subscription"),
            "homepage": "https://github.com/features/copilot",
            "endpoint": "copilot-cli",
            "model": "gpt-5.2-codex",
            "requires_key": false,
        ...
        "copilot-gpt-5.2": aiModelComponent.createObject(this, {
            "name": "GPT-5.2",
            "icon": "copilot-symbolic",
            "description": Translation.tr("GitHub Copilot | OpenAI GPT-5.2\nStrong general-purpose. Requires GitHub Copilot subscription"),
            "homepage": "https://github.com/features/copilot",
            "endpoint": "copilot-cli",
            "model": "gpt-5.2",
            "requires_key": false,
        ...
        "copilot-gpt-5-mini": aiModelComponent.createObject(this, {
            "name": "GPT-5 Mini",
            "icon": "copilot-symbolic",
            "description": Translation.tr("GitHub Copilot | OpenAI GPT-5 Mini\nLightweight and fast. Requires GitHub Copilot subscription"),
            "homepage": "https://github.com/features/copilot",
            "endpoint": "copilot-cli",
            "model": "gpt-5-mini",
            "requires_key": false,
    ...
    property var apiStrategies: {
        ...
        "copilot": copilotCliApiStrategy.createObject(this),
    }
    ...
    Process {
        ...
        function makeRequest() {
            ...
            // Special handling for Copilot CLI
